...
# transpose sample x mutation matrix, cal distance matrix, run PCoA
mXg.2 <- t(mXg.1)
mut.bc <- vegdist(mXg.2, method = "canberra", binary = "FALSE") #bray, jaccard, canbera
